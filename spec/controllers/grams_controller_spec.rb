...
RSpec.describe GramsController, type: :controller do
 describe "gram#destroy action" do 
     it "shouldnt allow user who didnt create the gram to destroy it" do 
 ...
 describe "gram#update action" do
     it "shouldnot let users who did not create the gram update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
     ...
     it "should have http 404 error if the update cannot be found " do
      user = FactoryBot.create(:user)
      sign_in user
 ...
 describe "grams#edit action" do
     it " shouldnt let a user who did not create a gram to edit the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
 ...
 describe "grams#create action" do
     ...
     it "should sucessfully create a new gram in the database" do
        user = FactoryBot.create(:user)
        sign_in user  
        post :create, params: {
         gram: {
